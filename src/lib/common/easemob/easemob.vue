          ...
          <div :class="{'show':isShowSideBar}" class="side_bar">
            ...
            <div class="user_info">
              <div class="avatar_wrapper">
                <img src="/static/easemob/images/user-3.png" class="avatar"/>
              </div>
              ...
              <div class="panel_header">
                <div class="panel_header_wrapper" style="padding: 0 14px;">
                  <div class="avatar_wrapper" @click="onOpenUserInfo">
                    <img class="avatar" src="/static/easemob/images/7.jpg"/>
                  ...
                  <li class="scrollbar active">
                    <ul class="user-list" id="user-list-session">
                      <li class="user-list_item">
                        <div class="avatar_wrapper">
                          <img class="avatar" src="/static/easemob/images/user-file.png"/>
                        </div>
            ...
            <div class="panel_body">
              ...
              <div class="scrollWrapper search search_container_scroll_area">
                <ul class="list list_white catogory_List">
                  <li class="list_item">
                    <a class="avatar">
                      <img src="/static/easemob/images/user-1.png" class="lazyLoadImg loaded"/>
                    </a>
                    <p class="member_nick">
...
<script type="text/ecmascript-6">
  ...
  import {applicationURL} from 'kalix-vue-lib/src/config/global.toml'
