...
<template lang="pug">
  keep-alive
    kalix-table(bizKey="news" title='新闻列表' v-bind:tableFields="tableFields" v-bind:targetURL="targetURL"
...
<script type="text/ecmascript-6">
  ...
  import {NewsURL, ToolButtonList} from '../config.toml'
