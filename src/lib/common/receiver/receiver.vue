...
<template lang="pug">
  keep-alive
    kalix-table(v-bind:bizKey="bizKey" title='收件列表'
    ref="kalixTable"
...
<script type="text/ecmascript-6">
  ...
  import {ReceiverURL, SenderToolButtonList} from '../config.toml'
  import {receiverSenderMixin} from '../mixin/receiverSenderMixin'
